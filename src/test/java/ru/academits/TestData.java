...
public class TestData {
	...
	static String state1 = "NCR";
//	static String state2 = "Uttar Pradesh";
//	static String state3 = "Haryana";

	static String city11 = "Delhi";
//	static String city12 = "Gurgaon";
//	static String city13 = "Noida";
